            ...
            <nav class="bg-white border-b border-gray-100">
                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            <!-- Logo -->
                            <div class="shrink-0 flex items-cente w-[52px] overflow-hidden">
                                <Link :href="route('stock-search.find')" class="flex items-center">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                <NavLink :href="route('stock-search.find')" :active="route().current('stock-search.find')">
                                    Dashboard
                                </NavLink>
                            </div>
                        </div>
                ...
                <div :class="{'block': showingNavigationDropdown, 'hidden': ! showingNavigationDropdown}" class="sm:hidden">
                    <div class="pt-2 pb-3 space-y-1">
                        <ResponsiveNavLink :href="route('stock-search.find')" :active="route().current('stock-search.find')">
                            Dashboard
                        </ResponsiveNavLink>
                    </div>
